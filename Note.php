 <?php
  ...
  $dz = mysqli_connect("localhost","Fabian","gnagflow","raspberry");
	...
	$ab3 = "SELECT zudafasdftaten.Name FROM zutaten INNER JOIN Cocktail_Zutaten ON Zutaten.ID = Cocktail_Zutaten.Z_ID INNER JOIN Cocktails ON cocktail_zutaten.C_ID = cocktails.ID WHERE cocktails.Name ='".$row2[0]."'";
